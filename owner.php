...
include 'includes/connect.php';
	...
	if($_SESSION['owner_sid']==session_id())
	{
		?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu1.php" novalidate="novalidate">
            <div class="row">
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/add2.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
