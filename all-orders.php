    ...
    include 'includes/connect.php';
      if(isset($_SESSION['admin_sid'])==session_id() || isset($_SESSION['owner_sid'])==session_id())
      {
        ?>
    <!DOCTYPE html>
    <html lang="en">
  ...
  include 'menu.php';
    }elseif (isset($_SESSION['owner_sid'])==session_id()) {
  ...
  <?php include("footer.php");?>
    ...
    <?php
      ...
      else
      {
        ...
        else if($_SESSION['owner_id']==session_id())
        {
          header("location:orders.php");
        }
        else{
